export const projects = [
  ...
  },
  {
    ...
    figmaLink:
      "https://www.figma.com/design/xxsVjxdPeKbqjH0MI36nhw/Zomato?node-id=0-1&t=Kr4TZmc3p086VHMZ-1",
    status: "Completed",
  },
  {
    title: "Revampmoto Redesign",
    description:
      "Transformed Revampmoto's main page with a contemporary design approach, enhancing functionality and aesthetics to align with the brand’s innovative image. Delivered a visually engaging and user-centric interface, optimizing navigation for a smoother browsing experience tailored to their audience. Technologies Used: HTML, CSS, JavaScript, GSAP, and Locomotive.js",
    ...
    figmaLink:
      "https://www.figma.com/design/FBmyJA1QRgFCAZjxRDgMjd/Revamp-Moto?node-id=0-1&t=Yae8RbbWl4Vh0avh-1",
    status: "Completed",
  },
  {
    title: " Internet Speed Test Chrome Extension",
    description:"A Chrome extension that measures your internet connection speed by downloading a test file and calculating the download speed in Mbps. It provides real-time results and allows users to monitor the quality of their internet connection. The extension is built to be simple, lightweight, and easy to use.",
    liveLink: null, // Not available
    codeLink: "https://github.com/ArslanDoddamani/KA29_Coders-ReimagineRound1",
    figmaLink: null,
    status: "Completed",
  },
